...
/*
Просуммировать числа от 1 до 1 000 000 000, используя потоки
Разбить вычисление на 1-50 потоков, т.е. сначала вычисление выполняется в 1м потоке,
затем в 2х, 3х и т.д. Замерить время вычисления каждого из вариантов. Определить,
с каким количеством потоков время выполнения минимально.
*/
